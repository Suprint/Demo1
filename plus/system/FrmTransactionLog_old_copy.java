 ...
 * */
public class FrmTransactionLog_old_copy extends AMPlusCore {
...
//				sBuf.append(log.getDestinationNo());
				sBuf.append(log.getDestinationNo().toString().trim().substring(2, log.getDestinationNo().toString().trim().length()));
				sBuf.append("\n");
			} else if (command.equals("1" + Config.M_IMART_THANH_TOAN)) {
				// topup mobile tra truoc
